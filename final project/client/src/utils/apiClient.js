...
// ----------------------------------------------------------------------
// FINAL FIX: This correctly constructs the base URL by checking for the 
// environment variable and appending '/api' only when needed.
...
  baseURL: BASE_API_URL, // <--- Now uses the guaranteed correct URL
  timeout: 15000,
  headers: {
